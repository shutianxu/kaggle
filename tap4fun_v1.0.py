...
'''
def data_process(X):
    X['wood'] = X['wood_reduce_value'] - X['wood_add_value']
    X['stone'] = X['stone_reduce_value'] - X['stone_add_value']
    X['ivory'] = X['ivory_reduce_value'] - X['ivory_add_value']
    X['meat'] = X['meat_reduce_value'] - X['meat_add_value']
    X['magic'] = X['magic_reduce_value'] - X['magic_add_value']
    X['infantry'] = X['infantry_reduce_value'] - X['infantry_add_value']
    X['cavalry'] = X['cavalry_reduce_value'] - X['cavalry_add_value']
    X['shaman'] = X['shaman_reduce_value'] - X['shaman_add_value']
    X['wound_infantry'] = X['wound_infantry_reduce_value'] - X['wound_infantry_add_value']
    X['wound_cavalry'] = X['wound_cavalry_reduce_value'] - X['wound_cavalry_add_value']
    X['wound_shaman'] = X['wound_shaman_reduce_value'] - X['wound_shaman_add_value']
    X['general_acceleration'] = X['general_acceleration_reduce_value'] - X['general_acceleration_add_value']
    X['building_acceleration'] = X['building_acceleration_reduce_value'] - X['building_acceleration_add_value']
